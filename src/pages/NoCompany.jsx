...
const T = {
  uz: {
    ...
    sub2: "Kompaniya nomini kiriting — hisobingiz darhol ochiladi.",
    trial: "Bepul — 4 foydalanuvchi, 2 loyiha",
    ...
    bossSub: "Bepul boshlang — 4 foydalanuvchi va 2 loyiha, muddatsiz.",
  ...
  ru: {
    ...
    sub2: "Введите название компании — аккаунт откроется сразу.",
    trial: "Бесплатно — 4 пользователя, 2 проекта",
    ...
    bossSub: "Начните бесплатно — 4 пользователя и 2 проекта, без срока.",
  ...
  en: {
    ...
    sub2: "Enter your company name — your account opens immediately.",
    trial: "Free — 4 users, 2 projects",
    ...
    bossSub: "Start free — 4 users and 2 projects, no time limit.",
